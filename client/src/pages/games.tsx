...
export default function Games() {
  const games = [
    ...
    },
    {
      id: "reading",
      title: "Reading Quest",
      description: "Embark on reading adventures and improve comprehension through interactive stories and challenges.",
      image: readingImage,
      path: "#",
    ...
    },
    {
      id: "science",
      title: "Science Lab",
      description: "Explore scientific concepts through virtual experiments and interactive simulations.",
      image: scienceImage,
      path: "#",
      difficulty: "Elementary to High School",
      estimatedTime: "15-30 min",
      skills: ["Scientific Method", "Experiments", "Observations"],
